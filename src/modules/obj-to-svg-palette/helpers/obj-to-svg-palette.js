    ...
    if (Object.hasOwnProperty.call(coolorscoObj, colorName)) {
      ...
      if (colorCount != 0 && colorCount % circlesPerRow === 0) {
        ...
        currentCoords.currentY +=
          circleDiameter + margin.y + marginTop + fontSizeTexts + marginTop1 + fontSizeTexts;
      }
      ...
      textColorHex.setAttribute(
        "y",
        currentCoords.currentY + circleDiameter + marginTop + fontSizeTexts + marginTop1
      );
